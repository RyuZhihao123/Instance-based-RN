...
if __name__ == '__main__':
    ...
    while exp_id < a.times:
        ...
        MLAE_train = SavePredictedResult(dir_results, x_train, y_train, 'trainset_usingTrain')
        MLAE_val = SavePredictedResult(dir_results, x_val, y_val, 'valset_usingTrain')
        MLAE_test = SavePredictedResult(dir_results, x_test, y_test, 'testset_usingTrain')
        ...
        MLAE_train_onVal = SavePredictedResult(dir_results, x_train, y_train, 'trainset_usingVal')
        MLAE_val_onVal = SavePredictedResult(dir_results, x_val, y_val, 'valset_usingVal')
        MLAE_test_onVal = SavePredictedResult(dir_results, x_test, y_test, 'testset_usingVal')
